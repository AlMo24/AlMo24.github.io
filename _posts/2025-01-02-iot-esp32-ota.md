...
Sadly it does not natively support SSH in the same way as full-fledged Linux devices, but it can be configured to mimic similar functionality using various techniques. Here’s an overview of the possibilities:
...
This setup ensures secure communication, remote configuration, and scalability for IoT devices in your MQTT network.